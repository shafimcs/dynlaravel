                    ...
                    <div class="col-md-10" style="margin-left:-280px;">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3>EDIT TESTIMONIAL DETAILS</h3>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input id="id" type="text" style="display: none" name="id" class="form-control" value="{{$testimonial->id}}">

                                        <div class="col-md-6">Enter Username :
                                            <input id="name" type="text" name="user_name" class="form-control" value="{{ $testimonial->user_name }}" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">Enter Testimonial Body :
                                                <textarea type="text" name="body" rows="7" cols="38" class="form-control" >{{$testimonial->body}}</textarea>
                                                @if ($errors->has('body'))
                                                    <span class="help-block">
                                            ...
                                            <div class="col-md-6">
                                                <div class="lib_image_holder" style="float: right">
                                                    <div id="pic" class="form-group">
                                                        ...
                                                        <img id="blah" src="{{ asset('storage/'.$testimonial->user_image) }}" alt=" no image choosen" />
