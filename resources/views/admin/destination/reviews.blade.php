                ...
                $.ajax(
                    {
                        ...
                        dataType: 'text',
                        type: "POST",
                        url: "{{ route('destination.review.delete') }}",
                        data: {id:id},
                ...
                $.ajax(
                    {
                        ...
                        dataType: 'text',
                        type: "POST",
                        url: "{{ route('push.destination.review.to.home') }}",
                        data: {id:id},
                        success: function (res) {
                            /*if(res =='false')
                            {

                                $('td.toinsert').append('<button class="btn btn-blue">Pushed</button>');
                                $("#reviewBtn").hide();
                ...
                $.ajax(
                    {
                        ...
                        dataType: 'text',
                        type: "POST",
                        url: "{{ route('push.destination.review.back') }}",
                        data: {id:id},
                        success: function (res) {
                            alert(res);
