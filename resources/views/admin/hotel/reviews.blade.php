                        ...
                        @foreach ($reviews as $review)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                    <button id="mybtn" onclick="pushtoHome({{ $review->id }})" class="btn btn-success">Push to home</button><br><br>&nbsp;&nbsp;
                                    @endif
                ...
                $.ajax(
                    {
                        ...
                        dataType: 'text',
                        type: "POST",
                        url: "{{ route('push.hotel.review.to.home') }}",
                        data: {id:id},
                        success: function (res) {
                            alert(res);
                ...
                $.ajax(
                    {
                        ...
                        dataType: 'text',
                        type: "POST",
                        url: "{{ route('push.hotel.review.back') }}",
                        data: {id:id},
                        success: function (res) {
                            alert(res);
