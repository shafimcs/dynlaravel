                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-6">Enter Package Type :
                                                <input id="name" type="text" name="category_name" class="form-control" placeholder="Enter Package Type" required>
                                                @if ($errors->has('name'))
                                                    <span class="help-block">
                                            ...
                                            <div class="col-md-6">
                                                Images :
                                                <div class="form-group has-feedback">
                                                    <input type="file" class="form-control" name="image" id="file" onchange="readURL(this);" multiple required>
                                                </div>
